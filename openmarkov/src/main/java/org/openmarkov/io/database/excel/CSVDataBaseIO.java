...
@CaseDatabaseFormat(extension = "csv", name = "CSV") public class CSVDataBaseIO
	...
	public CaseDatabase load(String fileName) throws IOException {
		 ...
		 * links.
		 */
		probNet = getBayesNetVariables(fileName, variablesNames, variablesStatesNames);
	 ...
	 */
	public void save(String fileName, ProbNet probNet, ArrayList<int[]> cases) throws Exception {
	 ...
	 */
	private ArrayList<String> getVariableNames(String firstLine) throws IOException {
	 ...
	 * <code>Integer[]</code>.
	 */
	private int[] getDataLine(String line, List<Map<String, Integer>> variablesStates,
			List<List<String>> variablesStatesNames) {
