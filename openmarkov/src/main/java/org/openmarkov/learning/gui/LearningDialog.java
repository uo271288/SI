 ...
 */
@SuppressWarnings("serial") @ToolPlugin(name = "Learning", command = "Tools.Learning") public class LearningDialog
	...
	@SuppressWarnings({ "unchecked", "rawtypes" }) private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel1Layout.createSequentialGroup().addContainerGap()
						...
						.add(jScrollPane2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 400,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(25, 25, 25)
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel1Layout.createSequentialGroup().addContainerGap()
						.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(jLabel1)
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				...
				.add(jPanel3Layout.createSequentialGroup().add(33, 33, 33)
						.add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(jPanel3Layout.createSequentialGroup().add(AlgorithmLabel).add(40, 40, 40)
										.add(algorithmComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 369,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
										.add(0, 0, Short.MAX_VALUE)).add(jScrollPane1)).add(18, 18, 18)
						.add(optionsButton)
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel3Layout.createSequentialGroup()
						...
						.add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(optionsButton).add(jScrollPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)).add(22, 22, 22)
						.add(jPanel6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap()));

		jPanel7.setBorder(
				javax.swing.BorderFactory.createTitledBorder(stringDatabase.getString("Learning.LearningType")));
		...
		jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel7Layout.createSequentialGroup().add(33, 33, 33)
						.add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(automaticLearningRadioButton).add(InteractiveLearningRadioButton))
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel7Layout.createSequentialGroup().add(InteractiveLearningRadioButton)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(automaticLearningRadioButton)
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		generalPanelLayout.setHorizontalGroup(
				generalPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(generalPanelLayout.createSequentialGroup().addContainerGap().add(generalPanelLayout
		...
		generalPanelLayout.setVerticalGroup(
				generalPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(generalPanelLayout.createSequentialGroup().addContainerGap()
								.add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(jPanel3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 121,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.add(jPanel7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(50, 50, 50)));

		generalTabbedPane.addTab(stringDatabase.getString("Learning.General"), generalPanel);

		jPanel2.setBorder(
				javax.swing.BorderFactory.createTitledBorder(stringDatabase.getString("Learning.ChooseModelNet")));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel2Layout.createSequentialGroup().addContainerGap()
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(jPanel2Layout.createSequentialGroup().add(jLabel2)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED).add(jScrollPane3)
										.add(22, 22, 22)).add(jPanel2Layout.createSequentialGroup()
										.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(jPanel2Layout.createSequentialGroup().add(fromFileRadioButton)
														.add(50, 50, 50).add(loadModelNetButton,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 88,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
												.add(noModelNetRadioButton).add(fromOpenMarkovRadioButton))
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel2Layout.createSequentialGroup()
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
								.add(jPanel2Layout.createSequentialGroup().add(noModelNetRadioButton)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
										.add(fromOpenMarkovRadioButton).add(2, 2, 2).add(fromFileRadioButton))
								.add(loadModelNetButton)).addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING).add(jLabel2)
								.add(jScrollPane3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 22,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		jPanel4.setBorder(
				javax.swing.BorderFactory.createTitledBorder(stringDatabase.getString("Learning.ModelNetUse")));
				...
				.add(jPanel4Layout.createSequentialGroup()
						.add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(jPanel4Layout.createSequentialGroup().add(19, 19, 19)
										.add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(useNodePositionsCheckBox).add(startFromModelNetCheckBox,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 244,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
								.add(jPanel4Layout.createSequentialGroup().add(59, 59, 59)
										.add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(deleteLinksModelNet).add(invertLinksModelNet)
												.add(addLinkModelNet))))
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel4Layout.createSequentialGroup().add(useNodePositionsCheckBox)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(startFromModelNetCheckBox)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(addLinkModelNet)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(deleteLinksModelNet)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(invertLinksModelNet)
				...
				variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(variablesPanelLayout.createSequentialGroup()
								.add(variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
										.add(variablesPanelLayout.createSequentialGroup().addContainerGap()
												.add(variablesPanelLayout
														...
														.add(variablesPanelLayout.createSequentialGroup()
																.add(selectedVariablesRadioButton,
																		...
																		192,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
																.add(28, 28, 28).add(selectDeselectCheckBox,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																		251,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
														.add(variablesPanelLayout.createParallelGroup(
																...
																.add(variablesPanelLayout.createSequentialGroup()
																		...
																		.add(20, 20, 20).add(variablesPanelLayout
																				.createParallelGroup(
																						org.jdesktop.layout.GroupLayout.LEADING)
																				...
																				.add(missingValuesComboBox,
																						...
																						278,
																						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
																		.add(50, 50, 50).add(variablesPanelLayout
																				.createParallelGroup(
																						org.jdesktop.layout.GroupLayout.LEADING,
																						false).add(numIntervalsCheckBox)
																				.add(variablesPanelLayout
																						.createSequentialGroup()
																						.add(5, 5, 5).add(jLabel10)
																						.add(10, 10, 10)
																						.add(numIntervalsSpinner,
																								...
																								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))))
														.add(variablesPanelLayout.createSequentialGroup()
																.add(21, 21, 21).add(jLabel3,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																		102,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
																.add(120, 120, 120).add(jLabel4,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																		90,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
																.add(120, 120, 120).add(jLabel5,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																		99,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
																.add(30, 30, 30).add(jLabel9,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																		121,
																		org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
																.add(21, 21, 21)).add(22, 22, 22)))
										.add(org.jdesktop.layout.GroupLayout.TRAILING,
												variablesPanelLayout.createSequentialGroup().add(10, 10, 10)
		...
		variablesPanelLayout.setVerticalGroup(
				variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(org.jdesktop.layout.GroupLayout.TRAILING, variablesPanelLayout.createSequentialGroup()
								...
								.add(variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
										.add(org.jdesktop.layout.GroupLayout.TRAILING,
												variablesPanelLayout.createSequentialGroup().add(variablesPanelLayout
														.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
														.add(discretizeComboBox,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
														.add(jLabel8)).add(4, 4, 4).add(variablesPanelLayout
														.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
														.add(jLabel6).add(missingValuesComboBox,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
														.add(numIntervalsSpinner,
																...
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
										.add(org.jdesktop.layout.GroupLayout.TRAILING,
												variablesPanelLayout.createSequentialGroup().add(numIntervalsCheckBox)
														.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
														.add(jLabel10)))
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								...
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(jLabel4).add(jLabel3).add(jLabel9).add(jLabel5)).add(5, 5, 5)
								.add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 180,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(52, 52, 52)));
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel5Layout.createSequentialGroup().addContainerGap().add(learnButton).add(14, 14, 14)
						.add(savePreprocessButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
						.add(resetButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 12, Short.MAX_VALUE)
		...
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel5Layout.createSequentialGroup()
						...
						.add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(learnButton).add(cancelButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(resetButton)
								.add(savePreprocessButton)).addContainerGap()));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				...
				.add(layout.createSequentialGroup().add(170, 170, 170)
		...
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(layout.createSequentialGroup()
						.add(generalTabbedPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 359,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(jPanel5, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
	...
	@SuppressWarnings("unchecked") private void missingValuesComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
	...
	private void loadCaseFile(String path) {
		if ((path != null) && (!path.equals(""))) {
			...
			if (reader == null) {
				JOptionPane
						.showMessageDialog(null, stringDatabase.getString("Learning.IncorrectCaseDatabaseFileFormat"),
				...
				try {
					...
					JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.LoadError"),
							stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
					ex.printStackTrace();
				}
			}
		...
		if (fromFileRadioButton.isSelected()) {
			...
			if (fileName != null) {
				if (!isSupportedNetFormat(fileName)) {
					JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.IncorrectFileFormat"),
							stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
					...
					try {
						...
						JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.UnableToLoadModelNet"),
								stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
						e.printStackTrace();
					}
				}
	...
	@SuppressWarnings("unchecked") private void discretizeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (savePreprocessFileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			if ((path != null) && (!path.equals(""))) {
				...
				if (writer == null) {
					...
					try {
						CaseDatabase preprocessedDb = MissingValues
								.process(database, getSelectedMissingValuesOptions());

						CaseDatabase discretizedDB = Discretization
								.process(preprocessedDb, getSelectedDiscretizeOptions(), getSelectedNumIntervals(),
										modelNet);
	...
	private void learnButtonActionPerformed(
		...
		if ((databasePath == null) || (databasePath.equals(""))) {
			JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.MustLoadACaseDatabase"),
					stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		List<Variable> selectedVariables = getSelectedVariables();
		if (selectedVariables.isEmpty()) {
			JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.MustChooseVariables"),
					stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		try {
			...
			discretizedDB = Discretization
					.process(preprocessedDatabase, getSelectedDiscretizeOptions(), getSelectedNumIntervals(), modelNet);
		} catch (Exception e) {
			JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.ErrorPreprocessing"),
					stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
			discretizedDB = null;
		}
		if (discretizedDB != null) {
			if (modelNet != null) {
				modelNetUse = new ModelNetUse(true, useNodePositionsCheckBox.isSelected(),
						startFromModelNetCheckBox.isSelected(), addLinkModelNet.isSelected(),
						deleteLinksModelNet.isSelected(), invertLinksModelNet.isSelected());
			}
			try {
				// Initialize learningManager
				LearningManager learningManager = new LearningManager(discretizedDB,
						algorithmComboBox.getSelectedItem().toString(), modelNet, modelNetUse);
				...
				if (optionsGUI != null) {
					...
					learningAlgorithm = learningManager
							.getAlgorithmInstance(algorithmComboBox.getSelectedItem().toString());
				}

				if (learningAlgorithm == null) {
					throw new InvalidParameterException(
							"Unable to instance learning algorithm " + algorithmComboBox.getSelectedItem().toString());
				}
				...
				if (automaticLearningRadioButton.isSelected()) {
					...
					System.out.print(stringDatabase.getString("Learning.LearningFinished") + calculateTime(
							elapsedTimeMillis) + "\n");
					...
					InteractiveLearningDialog interactiveLearningGUI = new InteractiveLearningDialog(this.parent, false,
							learningManager);
				...
				JOptionPane.showMessageDialog(null,
						stringDatabase.getString("Learning.Error.UnobservedVariables") + " :" + e1
								.getUnobservedVariables(), stringDatabase.getString("ErrorWindow.Title.Label"),
				...
				JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.Error.OutOfMemory"),
						stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	private void setProperName(ProbNet probNet) {
		int index = 1;
		String name = databasePath.substring(databasePath.lastIndexOf('\\') + 1, databasePath.lastIndexOf('.'))
				+ stringDatabase.getString("Learning.NetSuffix");

		/* If a network with the same name is already open, try with "_1",
		 * "_2"... suffixes.
		 */
		MDI mdi = MainPanel.getUniqueInstance().getMdi();
		if (mdi.getFrameByTitle(name) != null || mdi.getFrameByTitle("*" + name) != null) {
			name += "_" + index;
			while (mdi.getFrameByTitle(name) != null || mdi.getFrameByTitle("*" + name) != null) {
				index++;
	...
	private void numIntervalsCheckBoxActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numIntervalsCheckBoxActionPerformed
		int i = 0;
	...
	private void numIntervalsSpinnerStateChanged(
			javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_numIntervalsSpinnerStateChanged
		Integer selected = (Integer) numIntervalsSpinner.getValue();
	...
	private void noModelNetRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_noModelNetRadioButtonActionPerformed
		modelNet = null;
		modelNetTextPane.setText(null);
		loadModelNetButton.setEnabled(false);
	...
	private void fromOpenMarkovRadioButtonActionPerformed(
		...
		try {
			...
			noModelNetRadioButton.setSelected(true);
			JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.NoOpenNet"),
					stringDatabase.getString("ErrorWindow.Title.Label"), JOptionPane.ERROR_MESSAGE);
		}
	...
	private void fromFileRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fromFileRadioButtonActionPerformed
	...
	private void allVariablesRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allVariablesRadioButtonActionPerformed
	...
	private void selectedVariablesRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectedVariablesRadioButtonActionPerformed
	...
	private void modelNetVariablesRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modelNetVariablesRadioButtonActionPerformed
		if (modelNet == null) {
			JOptionPane.showMessageDialog(null, stringDatabase.getString("Learning.NoModelNet"), stringDatabase.
	...
	private void selectDeselectCheckBoxActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectDeselectCheckBoxActionPerformed
	...
	private void optionsButtonActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionsButtonActionPerformed
	...
	private void algorithmComboBoxActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_algorithmComboBoxActionPerformed
		String selectedAlgorithm = (String) algorithmComboBox.getSelectedItem();
		optionsGUI = algorithmConfigurationManager.getByName(selectedAlgorithm);
		optionsButton.setEnabled(optionsGUI != null);
		optionsTextArea.setText((optionsGUI != null) ? optionsGUI.getDescription() : "");
	...
	private void updateVariableSelectionPanel() {
		...
		if (database != null) {
			...
			for (Variable var : database.getVariables()) {
				...
				JComboBox<String> discretizeOptions = new JComboBox<String>(
				...
				if (modelNet != null) {
					try {
						VariableType variableTypeInModel = modelNet.getNode(var.getName()).getVariable()
								.getVariableType();
	...
	private void placeNodesInCircle(ProbNet probNet) {
		...
		for (int i = 0; i < nodes.size(); ++i) {
			...
			nodes.get(i).setCoordinateX(center.getX() + Math.sin(rad) * radius);
			nodes.get(i).setCoordinateY(center.getY() - Math.cos(rad) * radius);
		}
	}
