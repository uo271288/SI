 ...
 */
@MetricType(name = "BD") public class BDMetric extends BayesianMetric {
	...
	//     */
	//    protected double scoreNode (Node node,
	//                                Node extraParent,
	//                                boolean change)
	//    {
	...
	//            if (extraParent != null)
	//            {
	//                indexParents[0] = probNet.getNodes ().indexOf (extraParent);
	...
	//                indexParents[indexParent] = probNet.getNodes ().indexOf (parent);
	...
	//     * @param node <code>Node</code>
	//     * @param removedParent <code>Node</code>
	...
	//     * @throws openmarkov.exceptions.NotEnoughMemoryException
	//     */
	//    protected double scoreNodeRemovingLink(Node node, Node removedParent,
	...
	//                    indexParents[i] = probNet.getNodes().indexOf(parent);
	//                    variables.add((Variable) parent.getVariable());
