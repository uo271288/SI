...
public class NQueensGenAlgoUtil {
    ...
    public static Individual<Integer> generatePermutedIndividual(int boardSize) {
	List<Integer> individualRepresentation = new ArrayList<>();
	for (int i = 0; i < boardSize; i++) {
...
//	    return fitness;
	    ...
	    //seria esto pero falta el metodo getNumberOfAttackedQueens
//	    return boardSize-board.getNumberOfAttackedQueens();
	    return 0;
	}
    }
